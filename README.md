...
3) _`git clone https://github.com/W3LLLL/NGEWP.git`_
4) _`cd NGEWP`_
5) _`chmod 777 install.sh`_
6) _`bash install.sh`_

**Note :** 
1) _Whenever you logout the ROOT from putty remember to put command_ `cd NGEWP` _when you relogin._
2) _Command to run is_ `./NGEWP`
